...
namespace Bytebank.HARDCODED_DATABASE
{
    internal class RegisteredClients
    {
        ...
        {
            new Client(1,"André Souza","12345678900","Programador", new DateTime(),"Belo Horizonte - MG, Brasil", new CheckingAccount("1010-X", 15, _accountHolder!, 100m)),
            new Client(2,"Marisa Santos","00987654321","Arquiteta", new DateTime(),"Curitiba - PR, Brasil", new CheckingAccount("1018-5", 16, _accountHolder!, 200m)),
            new Client(3,"Carlos Sodré","11223344556","Economista", new DateTime(),"São Paulo - SP, Brasil", new CheckingAccount("8594-6", 17, _accountHolder!, 300m)),
        };
